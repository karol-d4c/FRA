...
abstract:
  R- package FRA is designed to performs fractional response analysi of single-cell responses as presented in the manuscript Nienałtowski et al. "Fractional response analysis reveals logarithmic cytokine responses in cellular populations" submitted (2020). A comprehensive documentation is available in directory XXXXXXXX.pdf.
